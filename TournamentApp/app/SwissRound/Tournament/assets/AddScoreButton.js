    ...
    return (
        <Pressable 
            ...
            <Animated.View style={{alignItems: 'center', justifyContent: 'center', borderRadius: 40, backgroundColor, height: 25, width: 25}}>
                <SafeAreaView style={{backgroundColor: 'rgba(0, 0, 0, 1)', width: 15, height: 3, borderRadius: 5, marginTop: 6}}/>
                <SafeAreaView style={{backgroundColor: 'rgba(0, 0, 0, 1)', width: 3, height: 15, borderRadius: 5, marginTop: -9}}/>
            </Animated.View>
        </Pressable>
    );
};
